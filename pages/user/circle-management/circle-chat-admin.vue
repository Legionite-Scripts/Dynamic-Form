      ...
      <div class="content mb-5">
        ...
        <div class="circle-admin flexed-column">
          <div class="flexed-row top-admin center">
            <img class="no-image" alt="Hero" />

            <div>
              <h3 class="weight-5 mb-1">Transporter</h3>
              <p class="mb-2 weight-4">Transporter Not Selected</p>
            </div>
          </div>
        </div>
        <div class="circle-admin flexed-column">
      ...
      <div class="content mb-5">
        ...
        <div class="chat-container">
          ...
          <div class="chat-row">
            ...
            <div>
              <h3 class="weight-5">Merchant User 3</h3>
              <p class="weight-3">I love this space.</p>
            </div>
          </div>
          ...
          <div class="chat-row">
            ...
            <div>
              <h3 class="weight-5">Merchant User 4</h3>
              <p class="weight-3">
                So i have some questions o. My products are really plenty o. Do
                we get to pay based on number of percels or the weight?
              </p>
            </div>
          </div>
...
.circle-admin > .admin-actions > div > button:last-child {
  border-radius: 2px;
  background: #ff3d22;
  color: #fff;
}
